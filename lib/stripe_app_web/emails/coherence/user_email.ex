...
defmodule StripeAppWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: StripeAppWeb.Coherence.EmailView, layout: {StripeAppWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
  ...
  def invitation(invitation, url) do
    %Email{}
    |> from("coding4medicine@gmail.com")
